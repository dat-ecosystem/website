...
function app_footer (opts = default_opts) {
  // ----------------------------------------
  // ID + JSON STATE
  // ----------------------------------------
  const id = count++
  ...
  apply_button_shadow.append(join_programe)
  const footer_window = window_bar({ name: 'FOOTER.pdf', src: icon_pdf_reader, data }, footer_protocol)
  windowbar_shadow.append(footer_window)
  // ----------------------------------------
  // INIT
  // ----------------------------------------
