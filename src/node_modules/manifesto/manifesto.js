  ...
  shadow.innerHTML = `<div class="mission_statement">
    ...
    <div class="main_wrapper">
      ...
      <div class="mission_content">
        <h2>manifesto</h2>
        <p>
        We, the "Dat Ecosystem" members, come together to achieve the following goals:<br><br>
      ...
      <div class="mission_content">
        ...
        <ul>
          ...
          <li>Have dat protocols (e.g. [hypercore-protocol][1] or similar) as a foundation of our work.</li>
        ...
        <p>This group is **governed by individuals** that form together _"the Consortium"_. The Consortium works to:</p>
        <ul>
          <li>Enact our [code of conduct](./code-of-conduct.md).</li>
        ...
        <p>
          Proposals are submitted as pull requests to /consortium/decisions/{YYY}.{MM}.{DD}-{proposal_name}.md in this repository.<br>
        ...
        <p>[1]: <a href="https://hypercore-protocol.org" target="_blank">https://hypercore-protocol.org</a></p>
        <p>Consortium members _(alphabetic order)_:</p>
        <ul>
