...
function project_filter (opts = default_opts, protocol) {
  ...
  const status_button = select_button({ data, name: 'STATUS', choices: ['ACTIVE', 'UNACTIVE', 'PAUSED'] }, project_filter_protocol)
  const tag_button = select_button({ data, name: 'TAGS', choices: tags }, project_filter_protocol)
