...
function tab_window (opts = default_opts, protocol) {
  ...
  function on_help (){
    return {content: `
      ...
      <br>
      <b>read</b>(<u>file_name</u>) // <i>file_address refers to the JSON address of the file. For instance 'read(info/mission_statement.md)'</i><br>
      ...
      Type list() for more info. Folders end with / <br>
      ------------------------------------------- <br>
      `, status: 'green'}
  }
