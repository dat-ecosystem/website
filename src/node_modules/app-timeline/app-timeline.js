...
function app_timeline (opts = default_opts, protocol) {
  ...
  const timeline_cards = cards_data.map(card_data => {
    const card = shadowfy()(timeline_card(card_data))
  ...
  main_wrapper.append(shadowfy()(timeline_filter({
    data, tags: Array.from(tags),
    latest_date: cards_data[0].date_raw
  }, app_timeline_protocol)))
  const year_filter_wrapper = shadowfy()(year_filter({
    data, latest_date: cards_data[0].date_raw
  }, app_timeline_protocol))
  const month_filter_wrapper = shadowfy()(month_filter({ data }, app_timeline_protocol))
  ...
  scrollbar_wrapper.append(shadowfy()(scrollbar({ data }, app_timeline_protocol)))
  ...
  function app_timeline_protocol (handshake, send) {
    ...
    async function setScroll (data) {
      ...
      timeline_cards.some((card, i) => {
        const card_date = cards_data[i].date
