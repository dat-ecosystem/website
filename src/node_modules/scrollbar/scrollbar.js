...
function scrollbar (opts = default_opts, protocol) {
  ...
  if (horizontal) {
    ...
    controls_wrapper.classList.add('horizontal-ctrls-wrapper')
    ...
    controls_wrapper.classList.add('vertical-ctrls-wrapper')
  ...
  controls.append(arrow_start_btn, arrow_end_btn)
  // ----------------------------------------
  // INIT
  // ----------------------------------------
  setTimeout(() => {
