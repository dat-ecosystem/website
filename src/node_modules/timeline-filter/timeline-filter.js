...
function timeline_filter (opts = default_opts, protocol) {
  ...
  // ELEMENTS
  // ----------------------------------------
  const status_button = shadowfy()(select_button({ data: opts.data, name: 'STATUS', choices: ['ACTIVE', 'UNACTIVE', 'PAUSED'] }, timeline_filter_protocol))
  const tag_button = shadowfy()(select_button({ data: opts.data, name: 'TAGS', choices: opts.tags }, timeline_filter_protocol))
  const search_project = shadowfy()(search_input(opts, timeline_filter_protocol))
  const month_button = shadowfy()(sm_icon_button({ src: icon_arrow_up, activate: true }))
  const year_btn = shadowfy()(year_button({ data: opts.data, latest_date: opts.latest_date }, timeline_filter_protocol))
