...
function tab_window (opts = default_opts, protocol) {
    ...
    if(typeof(response) === 'object'){
      return {content: '[' + Object.entries(response).map(v => {
        if(typeof(v[1]) === 'string')
          ...
          return v[0] + '/'
      }).toString().replace(/,/g, ', ') + ']', status: 'color1'}
    }
  ...
  function on_help (){
    return {content: `
      ##----------------------------------------- <br>
      ## <b>Description of commands</b> <br>
      ##----------------------------------------- <br>
      // <i>page_name refers to website pages. For instance 'goto(projects)'</i><br>
      <span class="prompt">goto(<u class="argument">page_name</u>)</span> <br>
      - goto command will bring you to the specified page <br>
      <br>
      // <i>folder_address refers to the JSON address of the folder. For instance 'list(info)'</i><br>
      ...
      <br>
      // <i>file_address refers to the JSON address of the file. For instance 'read(info/mission_statement.md)'</i><br>
